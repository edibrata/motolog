...
export const INTEL_CONFIG = [
    ...
    { id: 'brake-rear', name: 'Kampas Rem Belakang', interval: 10000, kws: ['kampas rem belakang', 'rem belakang', 'kanvas rem belakang'], color: 'blue' },
    { id: 'brake-front', name: 'Kampas Rem Depan', interval: 12000, kws: ['kampas rem depan', 'rem depan', 'kanvas rem depan'], color: 'indigo' },
